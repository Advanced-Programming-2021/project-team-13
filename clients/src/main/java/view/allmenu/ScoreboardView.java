...
public class ScoreboardView {
    ...
    public void printScoreBoard(String nickname, String rank, String score) {
        AnchorPane anchorPane = scoreboardLabel.getLabel(nickname,
                new Image
                        (Objects.requireNonNull(getClass().getResource("/scoreboardImage/tas.png"))
                                .toExternalForm()), Integer.parseInt(score), Integer.parseInt(rank));
