...
public class ImageLoader extends Thread {
    ...
    private static final File monsterFile = new File(System.getProperty("user.dir") + "/server/src/main/resources/shopImage/Monsters");
    private static final File spellTrapFile = new File(System.getProperty("user.dir") + "/server/src/main/resources/shopImage/SpellTrap");
