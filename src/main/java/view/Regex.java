...
public class Regex {
    ...
    public static final String ADD_CARD_TO_DECK1 = "^deck add-card (--\\w+ \\w+[ ]?\\w*) (--\\w+ \\w+[ ]?\\w*)( --side)?$";
    public static final String ADD_CARD_TO_DECK2 = "^deck add-card (--\\w+ \\w+[ ]?\\w*)( --side)? (--\\w+ \\w+[ ]?\\w*)$";
    public static final String ADD_CARD_TO_DECK3 = "^deck add-card( --side)? (--\\w+ \\w+[ ]?\\w*) (--\\w+ \\w+[ ]?\\w*)$";
    public static final String REMOVE_CARD_FROM_DECK1 = "^deck rm-card( --side)? (--\\w+ \\w+[ ]?\\w*) (--\\w+ \\w+[ ]?\\w*)$";
    public static final String REMOVE_CARD_FROM_DECK = "^deck rm-card (--\\w+ \\w+[ ]?\\w*)( --side)? (--\\w+ \\w+[ ]?\\w*)$";
    public static final String REMOVE_CARD_FROM_DECK2 = "^deck rm-card (--\\w+ \\w+[ ]?\\w*) (--\\w+ \\w+)[ ]?\\w*( --side)?$";
