...
public class Regex {
    ...
    public static final String ADD_CARD_TO_DECK1 = "^deck add-card (--\\w+ [^-]+) (--\\w+ [^-]+)( --side)?$";
    public static final String ADD_CARD_TO_DECK2 = "^deck add-card (--\\w+ [^-]+)( --side)? (--\\w+ [^-]+)$";
    public static final String ADD_CARD_TO_DECK3 = "^deck add-card( --side)? (--\\w+ [^-]+) (--\\w+ [^-]+)$";
    public static final String REMOVE_CARD_FROM_DECK1 = "^deck rm-card( --side)? (--\\w+ [^-]+) (--\\w+ [^-]+)$";
    public static final String REMOVE_CARD_FROM_DECK = "^deck rm-card (--\\w+ [^-]+)( --side)? (--\\w+ [^-]+)$";
    public static final String REMOVE_CARD_FROM_DECK2 = "^deck rm-card (--\\w+ [^-]+) (--\\w+ [^-]+)( --side)?$";
    ...
    public static final String TWO_PLAYER_DUEL = "^duel [^ ]+ [^ ]+ [^ ]+ [^ ]+ [^ ]+$";
    public static final String AI_DUEL = "^duel [^ ]+ [^ ]+ [^ ]+ [^ ]+$";
    ...
    public static String getCardName(String command) {
        Matcher matcher = getInputMatcher(command, "--card ([^-]+)");
        if (matcher.find())
    ...
    public static String getDeckName(String command) {
        Matcher matcher = getInputMatcher(command, "--deck (\\w+[ ]?\\w*)");
        if (matcher.find())
